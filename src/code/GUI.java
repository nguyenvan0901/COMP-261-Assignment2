...
public abstract class GUI {
	...
	protected abstract void onAStarComp();
	...
	private void initialise() {
		...
		JButton aStarComp = new JButton("A*Comp");
		aStarComp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onAStarComp();
				redraw();
			}
		...
		navigation.add(aStarComp);
		navigation.add(Time);
		navigation.add(west);
		navigation.add(south);
		navigation.add(east);
		navigation.add(aps);
		navigation.add(Distance);
